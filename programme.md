...
The reports linked to the programme are the technical reports that were submitted with the challenge systems. Authors have been invited to extend these after the workshop and final versions will appear in the workshop proceeding in the ISCA archive at the end of September.
...
<tr><td valign="top" style="margin-right: 5em; padding: 5px;"></td>
<td valign="top" style="margin-right: 5em; padding: 5px;">Poster 11</td><td style="padding: 5px;"><b> Modeling normal and impaired hearing with deep neural networks optimized for ecological tasks </b><a href="./papers/CPC3_E035_report.pdf">[Report]</a><br /> <span class="author">Mark R. Saddler<sup>1</sup>, Torsten Dau<sup>1</sup>, Josh H. McDermott<sup>2</sup></span> <i>( <sup>1</sup>DTU, Denmark; <sup>2</sup>MIT, US)</i></td>
</tr>
